...
const s = {
  ...
  /* Back nav — mix-blend-mode difference = theme-immune */
  nav: {
  ...
  /* Center wrapper — sits above canvas */
  center: {
    position: 'relative', zIndex: 10,
    minHeight: '100vh',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    padding: '6rem 1.5rem 2rem',
    /* No pointer-events on wrapper — let canvas get mouse events */
    pointerEvents: 'none',
  },
  ...
  card: {
    ...
    pointerEvents: 'auto', /* re-enable inside card */
  ...
  tab: (active) => ({
    flex: 1, padding: '0.65rem 0.5rem', border: 'none', background: 'none',
...
export default function Login() {
  ...
  return (
    <div style={s.root}>
      {/* Gravity mesh — gold-skinned yantra grid */}
      ...
      {/* Glass card floats above the mesh */}
      <div style={s.center}>
        <div style={s.card}>
          ...
          {GOOGLE_CLIENT_ID && (
            <>
              <button
                ...
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(201,147,58,0.20)'; e.currentTarget.style.background = 'rgba(255,255,255,0.04)' }}
              >
                <GoogleIcon />
          ...
          <form onSubmit={handleSubmit}>
            <div style={s.field}>
              ...
              <input
                ...
                onBlur={e  => e.target.style.borderColor = 'rgba(201,147,58,0.20)'}
              />
            </div>
            <div style={s.field}>
            ...
            <span style={s.footerText}>
              {tab === 'login'
                ? <>Don't have an account?{' '}
                    <button onClick={() => setTab('register')} style={s.footerBtn}>Create one free →</button>
                  </>
                : <>Already have an account?{' '}
                    <button onClick={() => setTab('login')} style={s.footerBtn}>Sign in →</button>
                  </>
              }
            </span>
