      ...
      <div style={S.content}>
        ...
        <section style={{ ...S.sec, justifyItems:'center' }}>
          <div style={{ ...S.glass, gridColumn:'3 / span 8', textAlign:'center', justifySelf:'center' }}>
            ...
            <div style={S.ftrRow}>
              {[{l:'My Charts',t:'/my-charts'},{l:'Horoscope',t:'/horoscope'},{l:'Sade Sati',t:'/sade-sati'},{l:'Doshas',t:'/doshas'},{l:'Destiny Chat',t:'/destiny-chat'},{l:'Numerology',t:'/numerology'},{l:'Pricing',t:'/pricing'},{l:'Sign In',t:'/login'}].map(lk => (
