  ...
  return (
    <div className="bh-fade-up-2">
      <button onClick={onReset} style={{
        ...
        ← Choose different date / location
      </button>
      ...
      <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
        ...
        <div style={{ fontSize: '0.76rem', color: 'var(--text-dim)', marginTop: '0.25rem' }}>
          Sunrise {sunrise} · Sunset {sunset} · Sidereal / Lahiri
        </div>
      </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: '0.72rem', color: 'var(--text-dim)', marginTop: '0.1rem' }}>{vara.hi} · Lord: {vara.lord}</div>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '1rem', marginBottom: '1.5rem' }}>
        ...
        {/* Tithi */}
        <LimbCard icon="🌙" label="Tithi" hi="तिथि">
        ...
        <LimbCard icon="⭐" label="Nakshatra" hi="नक्षत्र">
          ...
          <div style={{ fontSize: '0.78rem', color: 'var(--text-dim)', marginBottom: '0.2rem' }}>Lord: {nakshatra.lord} · Deity: {nakshatra.deity}</div>
        ...
        <LimbCard icon="◐" label="Karana" hi="करण">
          ...
          <div style={{ fontSize: '0.78rem', color: 'var(--text-dim)', marginBottom: '0.2rem' }}>
            Type: {karana.type.charAt(0).toUpperCase() + karana.type.slice(1)} · Lord: {karana.lord}
          </div>
          {karana.note && (
      ...
      <div style={{
        ...
        <div style={{ fontSize: '0.62rem', color: 'var(--text-dim)', fontFamily: "'JetBrains Mono', monospace", letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '0.5rem' }}>
          Planetary Context (Sidereal · Lahiri)
        </div>
        <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
          <div style={{ fontSize: '0.8rem' }}>
            <span style={{ color: 'var(--text-dim)' }}>☀ Sun: </span>
            <span style={{ color: GOLD }}>{sun.sign} {sun.lon.toFixed(1)}°</span>
          </div>
          <div style={{ fontSize: '0.8rem' }}>
            <span style={{ color: 'var(--text-dim)' }}>☽ Moon: </span>
            <span style={{ color: GOLD }}>{moon.sign} {moon.lon.toFixed(1)}°</span>
          </div>
        </div>
      </div>
    ...
    <div style={{ maxWidth: '860px', margin: '0 auto', padding: '2rem 1.5rem 4rem' }}>
      ...
      <div className="bh-fade-up" style={{ textAlign: 'center', marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem', lineHeight: 1.7, maxWidth: '520px', margin: '0 auto' }}>
          The five limbs of the Vedic almanac — Tithi, Nakshatra, Vara, Yoga &amp; Karana — plus auspicious timings, computed with Swiss Ephemeris precision.
        </p>
      </div>
        ...
        <>
          ...
          <div className="bh-fade-up-2" style={{
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.84rem', lineHeight: 1.75, margin: 0 }}>
              Panchang (पञ्चांग) means "five limbs". <strong style={{ color: GOLD_L }}>Tithi</strong> (lunar day) governs the spiritual quality of the day. <strong style={{ color: GOLD_L }}>Nakshatra</strong> (Moon's asterism) shapes its energy. <strong style={{ color: GOLD_L }}>Vara</strong> (weekday) sets the planetary lord. <strong style={{ color: GOLD_L }}>Yoga</strong> (Sun+Moon combination) indicates overall auspiciousness. <strong style={{ color: GOLD_L }}>Karana</strong> (half-tithi) guides action timing. All five together define the Muhurat — the quality of any given moment.
            </p>
          </div>
        </>
      )}
